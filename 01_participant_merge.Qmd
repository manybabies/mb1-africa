...
* `05_confirmatory_analysis` is the set of confirmatory analyses that were preregisted (see [here](https://osf.io/grqau/))
...
td$lab <- tolower(td$lab) # "pscuj" "kizito - uganda" "ghana"
pd$lab <- tolower(pd$lab) # "pscuj" "ucad" "uganda" "unima_zomba" "chuk" "smu" "ghana" "ke-nanyuki" 
