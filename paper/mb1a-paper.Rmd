...
Overall, at the trial level, `r nrow(excluded_trials_d)` trials (`r proportion_excluded_trials * 100`% of all trials) were excluded. Due to experimental setup errors, data from two sites were unusable, leading to the exclusion of `r unusable_participants` infants (`r proportion_excluded_participants * 100`% of all tested participants). No additional test sessions were excluded.
