...
\affiliation{\vspace{0.5cm}\textsuperscript{1} Stanford University, USA\\\textsuperscript{2} Arizona State University, USA\\\textsuperscript{3} Institute for Human Development, Aga Khan University, Kenya\\\textsuperscript{4} Addis Ababa University, Ethiopia\\\textsuperscript{5} Cheikh Anta Diop University - Dakar, Senegal\\\textsuperscript{6} United States International University-Africa, Kenya\\\textsuperscript{7} University of Jos, Nigeria\\\textsuperscript{8} Max Planck Institute for Psycholinguistics, The Netherlands\\\textsuperscript{9} University of Potsdam, Germany\\\textsuperscript{10} Sefako Makgatho Health Sciences University, South Africa\\\textsuperscript{11} University of Vermont, USA\\\textsuperscript{12} Humboldt-Universität, Berlin, Germany and University of Ghana, Legon, Ghana\\\textsuperscript{13} University of Portsmouth, UK\\\textsuperscript{14} Busara Center for Behavioral Economics, Kenya\\\textsuperscript{15} Makerere University, Uganda\\\textsuperscript{16} University of Malawi, Chancellor College, Zomba, Malawi\\\textsuperscript{17} Maseno University, Kenya\\\textsuperscript{18} St.~Peter Specialized Hospital, Ethiopia\\\textsuperscript{19} University Teaching Hospital of Kigali, Rwanda\\\textsuperscript{20} Princeton University, USA\\\textsuperscript{21} Sapienza University, Italy \& Kisii University, Kenya}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{mb1a-paper_files/figure-latex/unnamed-chunk-1-1.pdf}}
\caption{\label{fig:unnamed-chunk-1}Map shows the location of the eight participating labs.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{mb1a-paper_files/figure-latex/unnamed-chunk-5-1.pdf}}
\caption{\label{fig:unnamed-chunk-5}Histograms of the age distribution in each lab. X-axis represents the age in months.}
\end{figure}

Our final sample included 200 infants (see Table 2 for more specific sample demographic information) from 6 laboratories (mean sample size per laboratory: 33.33, SD: 5.16, range: 27 -- 41). The mean age of infants included in the study was 10.0 months (range: 2.3 -- 19.9). Similar to MB1, each laboratory was asked to collect data spanning the two target age ranges (3;0 -- 9;0 and 9;1 -- 15;0 months); however, in practice, many laboratories recruited participants outside the intended windows (younger than 3-month-old: \emph{N} = 4; older than 15-month-old: \emph{N} = 16). We did not exclude these infants from our analyses. See Figure 2 for a distribution of the age of the included participants in each site. An additional 60 infants were tested but excluded (see the full details on exclusions above).
...
Based on the above-mentioned criteria, 110 infants were classified as monolingual infants, 13 infants were classified as bilingual infants, and 31 infants were classified as other. The remaining 46 infants' language background was unknown.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{mb1a-paper_files/figure-latex/unnamed-chunk-10-1.pdf}}
\caption{\label{fig:unnamed-chunk-10}By lab results. Each dot represents one trial of looking time. X-axis represents the trial number. Y-axis represents the log looking time in seconds. Red represents IDS trials. Blue represents ADS trials.}
\end{figure}
...
\texttt{log\_lt\ \textasciitilde{}\ trial\_type\ +\ trial\_num\ +\ age\_months\ +\ infant\_type\ +\ language\_background\ +\ trial\_type\ *\ trial\_num\ +\ age\_months\ *\ trial\_num\ +\ age\_months\ *\ trial\_type\ +\ trial\_type\ *\ infant\_type\ +\ trial\_num\ *\ infant\_type\ +\ trial\_type\ *\ language\_background\ +\ (trial\_type\ *\ trial\_num\ \textbar{}\ subid)\ +\ (trial\_type\ \textbar{}\ lab)}
...
After pruning for non-convergence, our final model specification was: \texttt{log\_lt\ \textasciitilde{}\ trial\_type\ +\ trial\_num\ +\ age\_months\ +\ infant\_type\ +\ language\_background\ +\ trial\_type\ *\ trial\_num\ +\ age\_months\ *\ trial\_num\ +\ age\_months\ *\ trial\_type\ +\ trial\_type\ *\ infant\_type\ +\ trial\_num\ *\ infant\_type\ +\ trial\_type\ *\ language\_background\ +\ (1\ \textbar{}\ subid)\ +\ (1\ \textbar{}\ lab)}. The fixed effect estimate corresponding to our research question is the \texttt{trial\_type\ *\ infant\_type}, which captures differences in measured IDS preference between the current data and data from MB1/MB1B in units of log seconds of looking time.
...
The model revealed no significant difference in IDS preference between infants tested in our sample and those tested in MB1/MB1B, as indicated by the non-significant interaction between trial type and infant type (Table 4; \emph{\(\beta\)} = 0 {[}-0.06, 0.06{]}; \emph{SE} = 0.03; \emph{t} = 0.03; \emph{p} = 0.97). However, the simple effect of trial type was significant for the monolingual reference group (\emph{\(\beta\)} = 0.06 {[}0.04, 0.09{]}; \emph{SE} = 0.01; \emph{t} = 5.13; \emph{p} \textless{} .001), and the non-significant trial type × infant type interaction indicates a comparable preference in our African sample.

Consistent with expectations, looking times decreased over the course of the session (\emph{\(\beta\)} = -0.05 {[}-0.05, -0.05{]}; \emph{SE} = 0; \emph{t} = -31.08; \emph{p} \textless{} 0.01), and older infants looked for less time overall (\emph{\(\beta\)} = -0.12 {[}-0.15, -0.09{]}; \emph{SE} = 0.01; \emph{t} = -8.26; p \textless{} .001). We also found that older infants habituated more quickly, as indicated by a significant negative interaction between age and trial number (\emph{\(\beta\)} = 0 {[}-0.01, 0{]}; \emph{SE} = 0; \emph{t} = -3.79; p \textless{} .001). The interaction between trial number and infant type was also significant (\emph{\(\beta\)} = 0.02 {[}0.01, 0.03{]}; \emph{SE} = 0; \emph{t} = 6.64; p \textless{} .001), indicating that looking times declined more slowly across trials for infants in our sample compared to those in MB1/MB1B. No other interactions reached significance.
...
These efforts resonate with broader calls to diversify and globalize infant research. Recent commentaries have highlighted that developmental science continues to draw disproportionately from Western contexts, and have urged the field to address the structural barriers that prevent broader participation (Kidd \& Garcia, 2022; Singh, Cristia, Karasik, Rajendra, \& Oakes, 2023). Equitable global collaboration requires attention not only to sampling diversity but also to the power dynamics and infrastructural inequities that shape how research is conducted and credited. Encouragingly, recent initiatives such as the /L+/ Global School on Language Acquisition (Aravena-Bravo et al., 2024), co-led by several members of the MB1-Africa team, demonstrate how capacity building can foster sustainable participation from underrepresented regions.
...
Aravena-Bravo, P., Cristia, A., Garcia, R., Kotera, H., Nicolas, R. K., Laranjo, R., et al.others. (2024). Towards diversifying early language development research: The first truly global international summer/winter school on language acquisition (/l+/) 2021. \emph{Journal of Cognition and Development}, \emph{25}(2), 242--260.

\bibitem[\citeproctext]{ref-barr2013a}
...
\bibitem[\citeproctext]{ref-baumgartner2023build}
...
\bibitem[\citeproctext]{ref-broesch2015b}
...
\bibitem[\citeproctext]{ref-bryant2007recognizing}
...
\bibitem[\citeproctext]{ref-bryant2012recognizing}
...
\bibitem[\citeproctext]{ref-byers2021multilab}
...
\bibitem[\citeproctext]{ref-casillas2021}
...
\bibitem[\citeproctext]{ref-coles2022build}
...
\bibitem[\citeproctext]{ref-cooper1997}
...
\bibitem[\citeproctext]{ref-cooper1994}
...
\bibitem[\citeproctext]{ref-cristia2019child}
...
\bibitem[\citeproctext]{ref-csibra2016}
...
\bibitem[\citeproctext]{ref-dunst2012preference}
...
\bibitem[\citeproctext]{ref-farran2016cross}
...
\bibitem[\citeproctext]{ref-fernald1985}
...
\bibitem[\citeproctext]{ref-grafestes2013}
...
\bibitem[\citeproctext]{ref-grieser1988maternal}
...
\bibitem[\citeproctext]{ref-hayashi2001}
...
\bibitem[\citeproctext]{ref-heath1983}
...
\bibitem[\citeproctext]{ref-huttenlocher2010sources}
...
\bibitem[\citeproctext]{ref-keller2012}
...
\bibitem[\citeproctext]{ref-kitamura2009}
...
\bibitem[\citeproctext]{ref-kitamura2001universality}
...
\bibitem[\citeproctext]{ref-mathur2020robust}
...
\bibitem[\citeproctext]{ref-nielsen2017}
...
\bibitem[\citeproctext]{ref-omane2024vowel}
Omane, P. O., Benders, T., \& Boll-Avetisyan, N. (2024). Vowel harmony preferences in infants growing up in multilingual ghana (africa). \emph{Developmental Psychology}, \emph{60}(8), 1372.

\bibitem[\citeproctext]{ref-omane2025exploring}
Omane, P. O., Benders, T., \& Boll-Avetisyan, N. (2025). Exploring the nature of multilingual input to infants in multiple caregiver families in an african city: The case of accra (ghana). \emph{Cognitive Development}, \emph{74}, 101558.

\bibitem[\citeproctext]{ref-Omane_Boll-Avetisyan_Benders_2025}
Omane, P. O., Boll-Avetisyan, N., \& Benders, T. (2025). Tongue root harmony cues for speech segmentation in multilingually raised infants learning languages with and without vowel harmony in ghana (africa). \emph{Bilingualism: Language and Cognition}, 1--11. \url{https://doi.org/10.1017/S1366728925100485}

\bibitem[\citeproctext]{ref-openscience2015}
...
\bibitem[\citeproctext]{ref-parsons2019psychological}
...
\bibitem[\citeproctext]{ref-pegg1992}
...
\bibitem[\citeproctext]{ref-posel2016}
...
\bibitem[\citeproctext]{ref-pyykko2019early}
...
\bibitem[\citeproctext]{ref-ramirez2014}
...
\bibitem[\citeproctext]{ref-rowe2012longitudinal}
...
\bibitem[\citeproctext]{ref-santesso2007frontal}
...
\bibitem[\citeproctext]{ref-schneidman2012}
...
\bibitem[\citeproctext]{ref-schreiner2024limited}
...
\bibitem[\citeproctext]{ref-shneidman2012language}
...
\bibitem[\citeproctext]{ref-singh2002}
...
\bibitem[\citeproctext]{ref-singh2009influences}
...
\bibitem[\citeproctext]{ref-soderstrom2024testing}
...
\bibitem[\citeproctext]{ref-vogt2015communicative}
...
\bibitem[\citeproctext]{ref-weber2017cultural}
...
\bibitem[\citeproctext]{ref-weisleder2013talking}
...
\bibitem[\citeproctext]{ref-werker1989infant}
...
\bibitem[\citeproctext]{ref-werker1994cross}
...
\bibitem[\citeproctext]{ref-zettersten2024evidence}
